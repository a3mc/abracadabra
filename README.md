...
./target/release/abracadabra --unit solanad.service --since "1 hour ago"
./target/release/abracadabra --unit solanad.service --since "2 hours ago"
./target/release/abracadabra --unit solanad.service --since "30 min ago"
```
